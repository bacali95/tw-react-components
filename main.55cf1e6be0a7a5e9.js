(self["webpackChunktw_react_components"] = self["webpackChunktw_react_components"] || []).push([[179],{
...
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/24/outline/esm/XMarkIcon.js


function XMarkIcon_XMarkIcon({
  title,
  titleId,
  ...props
}, svgRef) {
...
const ForwardRef = react.forwardRef(XMarkIcon_XMarkIcon);
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/helpers/compareDates.ts

function compareDates(date1, date2, startOf) {
  if (startOf) {
    date1 = dayjs_min_default()(date1).startOf(startOf).toDate();
    date2 = dayjs_min_default()(date2).startOf(startOf).toDate();
  }
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/helpers/getDisplayDate.ts


dayjs_min_default().extend((advancedFormat_default()));
function getDisplayDate(date, format, locale) {
  return (locale ? dayjs_min_default()(date).locale(locale) : dayjs_min_default()(date)).format(format);
}
;// CONCATENATED MODULE: ./libs/tw-react-components/src/helpers/isEmpty.ts

function isEmpty_isEmpty(s) {
  if (Array.isArray(s)) return s.length === 0;
  return [null, undefined, ''].includes(s);
}
;// CONCATENATED MODULE: ./libs/tw-react-components/src/helpers/resolveTargetObject.ts


function resolveTargetObject_resolveTargetObject(payload, fieldChain) {
  ...
  if (Array.isArray(payload)) {
    ...
    return resolveTargetObject_resolveTargetObject(payload[index], rest);
  }
  return resolveTargetObject_resolveTargetObject(payload[key], rest);
}
;// CONCATENATED MODULE: ./libs/tw-react-components/src/helpers/index.ts
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/hooks/useDays.ts
...
function useDays(locale = 'en') {
  return (0,react.useMemo)(() => {
    dayjs_min_default().extend((localeData_default())).locale(locale);
    const names = dayjs_min_default().weekdays();
    const shortNames = dayjs_min_default().weekdaysShort();
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/hooks/useLongPress.ts



function useLongPress(callback, ms = 100) {
  const [startLongPress, setStartLongPress] = (0,react.useState)(false);
  (0,react.useEffect)(() => {
    let timerId;
    if (startLongPress) {
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/hooks/useMonths.ts
...
function useMonths(locale = 'en') {
  return (0,react.useMemo)(() => {
    dayjs_min_default().extend((localeData_default())).locale(locale);
    const names = dayjs_min_default().months();
    const shortNames = dayjs_min_default().monthsShort();
    return names.map((name, index) => ({
      name,
      shortName: shortNames[index],
      index
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/hooks/useOutsideClick.ts
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/hooks/index.ts
...
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/24/outline/esm/ExclamationTriangleIcon.js
...
const ExclamationTriangleIcon_ForwardRef = react.forwardRef(ExclamationTriangleIcon);
/* harmony default export */ const esm_ExclamationTriangleIcon = (ExclamationTriangleIcon_ForwardRef);
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/24/outline/esm/QuestionMarkCircleIcon.js
...
const QuestionMarkCircleIcon_ForwardRef = react.forwardRef(QuestionMarkCircleIcon);
/* harmony default export */ const esm_QuestionMarkCircleIcon = (QuestionMarkCircleIcon_ForwardRef);
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(5893);
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/Tooltip/index.tsx
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/Label.tsx
...
const Label_Label = ({
  ...
  return !children ? null : /*#__PURE__*/(0,jsx_runtime.jsxs)("label", {
    className: classnames_default()('flex items-center gap-1 font-medium', {
      'text-gray-700 dark:text-gray-100': !hasErrors,
      'text-red-600 dark:text-red-500': hasErrors
    }),
    htmlFor: htmlFor,
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("span", {
      children: [children, " ", required && /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
        className: "text-red-600",
        children: "*"
      })]
    }), description && /*#__PURE__*/(0,jsx_runtime.jsx)(Tooltip, {
      content: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "max-w-xs",
        children: description
      }),
      placement: "right",
      children: /*#__PURE__*/(0,jsx_runtime.jsx)(esm_QuestionMarkCircleIcon, {
        className: "h-5 w-5"
      })
    })]
  });
};
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/primitive/BasicInput.tsx

const _excluded = ["className", "type", "label", "description", "hasErrors", "ExtraIcon", "onExtraIconClick"];
...
const classes = {
  ...
  withoutErrors: {
    input: 'border-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:!border-blue-600 dark:placeholder-gray-500 dark:placeholder-gray-400',
    extension: 'border-gray-300 text-gray-600 peer-focus:border-blue-600 peer-focus:ring-blue-600 dark:border-gray-600 dark:text-white'
  },
  withErrors: {
    input: '!border-red-600 dark:bg-gray-700 placeholder-red-900 !ring-red-600 dark:!border-red-500 dark:!placeholder-red-500 dark:!ring-red-600',
    extension: 'border-red-600 text-red-600 peer-focus:border-red-600 peer-focus:ring-red-600 dark:border-red-500 dark:text-red-500'
  }
};
const BasicInput = /*#__PURE__*/(0,react.forwardRef)(function BasicInput(_ref, ref) {
  let {
      className,
      type = 'text',
      label,
  ...
  const memoLabel = (0,react.useMemo)(() => label && /*#__PURE__*/(0,jsx_runtime.jsx)(Label_Label, {
    htmlFor: id,
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: classnames_default()(className, 'dark:text-white'),
    children: [type !== 'checkbox' && memoLabel, /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: classnames_default()('flex', {
        'mt-1': label && type !== 'checkbox',
        'h-8 items-center gap-2': type === 'checkbox'
      }),
      children: [type === 'textarea' ? /*#__PURE__*/(0,jsx_runtime.jsx)("textarea", Object.assign({
        id: id,
        className: classnames_default()(classes.base.input, {
        ...
        value: props.value,
        ref: ref
      })) : type === 'checkbox' ? /*#__PURE__*/(0,jsx_runtime.jsx)("input", Object.assign({
        id: id,
        className: classnames_default()('h-5 w-5 rounded border-gray-300 text-blue-600', {
          'bg-red-100': hasErrors
        }),
        type: type
      }, props, {
        ref: ref
      })) : /*#__PURE__*/(0,jsx_runtime.jsx)("input", Object.assign({
        id: id,
        className: classnames_default()(classes.base.input, {
          [classes.withoutErrors.input]: !hasErrors,
          [classes.withErrors.input]: hasErrors,
        ...
        value: props.value,
        ref: ref
      })), type === 'checkbox' && memoLabel, type !== 'checkbox' && (hasErrors || ExtraIcon) && /*#__PURE__*/(0,jsx_runtime.jsxs)(BasicInputExtension, {
        hasErrors: hasErrors,
        onClick: !hasErrors ? onExtraIconClick : undefined,
        children: [hasErrors && !ExtraIcon && /*#__PURE__*/(0,jsx_runtime.jsx)(esm_ExclamationTriangleIcon, {
          className: "h-6 w-6"
        }), ExtraIcon && /*#__PURE__*/(0,jsx_runtime.jsx)(ExtraIcon, {
          className: "h-6 w-6"
        })]
      })]
    })]
...
const BasicInputExtension = ({
  children,
  hasErrors,
  onClick
}) => /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
  className: classnames_default()('flex items-center rounded-r-md border border-l-0 bg-gray-50 px-2 peer-focus:border-l peer-focus:ring-1 dark:bg-gray-700', {
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/primitive/CheckBoxInput.tsx




const CheckboxInput = /*#__PURE__*/(0,react.forwardRef)((props, ref) => /*#__PURE__*/(0,jsx_runtime.jsx)(BasicInput, Object.assign({
  type: "checkbox"
}, props, {
  ref: ref
})));
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/primitive/NumberInput.tsx




const NumberInput = /*#__PURE__*/(0,react.forwardRef)((props, ref) => /*#__PURE__*/(0,jsx_runtime.jsx)(BasicInput, Object.assign({
  type: "number"
}, props, {
  ref: ref
})));
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/primitive/TextareaInput.tsx




const TextareaInput = /*#__PURE__*/(0,react.forwardRef)((props, ref) => /*#__PURE__*/(0,jsx_runtime.jsx)(BasicInput, Object.assign({
  type: "textarea"
}, props, {
  ref: ref
})));
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/primitive/TextInput.tsx




const TextInput = /*#__PURE__*/(0,react.forwardRef)((props, ref) => /*#__PURE__*/(0,jsx_runtime.jsx)(BasicInput, Object.assign({
  type: "text"
}, props, {
  ref: ref
})));
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/primitive/index.ts
...
const ChevronLeftIcon_ForwardRef = react.forwardRef(ChevronLeftIcon);
/* harmony default export */ const esm_ChevronLeftIcon = (ChevronLeftIcon_ForwardRef);
...
const ChevronRightIcon_ForwardRef = react.forwardRef(ChevronRightIcon);
/* harmony default export */ const esm_ChevronRightIcon = (ChevronRightIcon_ForwardRef);
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/custom/date-time/DaysView.tsx
...
const DaysView = ({
  ...
  const monthDays = (0,react.useMemo)(() => {
  ...
  const prefixDays = (0,react.useMemo)(() => {
  ...
  const suffixDays = (0,react.useMemo)(() => {
  ...
  const setDayNumber = (0,react.useCallback)((newDay, newMonth = month, newYear = year) => () => {
    const newDate = new Date(newYear, newMonth, newDay, date.getHours(), date.getMinutes());
    if (minDate) {
      const _minDate = new Date(minDate);
      if (_minDate.getFullYear() === newYear && _minDate.getMonth() === newMonth && _minDate.getDate() === newDay) {
    ...
    if (maxDate) {
      ...
      if (_maxDate.getFullYear() === newYear && _maxDate.getMonth() === newMonth && _maxDate.getDate() === newDay) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      ...
      children: days.map((day, index) => /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
        className: "flex h-8 w-8 items-center justify-center text-xs uppercase text-gray-500 dark:text-gray-400",
        children: day.shortName
      }, index))
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "grid grid-cols-7 gap-1",
      children: [prefixDays.map((dayNumber, index) => /*#__PURE__*/(0,jsx_runtime.jsx)(Day, {
        value: value,
        day: dayNumber,
        month: (month - 1 + 12) % 12,
      ...
      }, `${dayNumber}-${index}`)), monthDays.map((dayNumber, index) => /*#__PURE__*/(0,jsx_runtime.jsx)(Day, {
        value: value,
        day: dayNumber,
        month: month,
        year: year,
        ...
        primary: true,
        setDayNumber: setDayNumber
      }, `${dayNumber}-${index}`)), suffixDays.map((dayNumber, index) => /*#__PURE__*/(0,jsx_runtime.jsx)(Day, {
        value: value,
        day: dayNumber,
        month: (month + 1) % 12,
...
const Day = ({
  ...
  const dayDate = (0,react.useMemo)(() => new Date(year, month, day), [day, month, year]);
  const isSelectable = (0,react.useMemo)(() => (!minDate || compareDates(dayDate, new Date(minDate), 'day') >= 0) && (!maxDate || compareDates(dayDate, new Date(maxDate), 'day') <= 0), [minDate, dayDate, maxDate]);
  const isSelected = (0,react.useMemo)(() => !!value && !compareDates(dayDate, new Date(value), 'day'), [dayDate, value]);
  const isEqualToday = (0,react.useMemo)(() => !compareDates(dayDate, new Date(), 'day'), [dayDate]);
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    className: classnames_default()('mx-auto flex h-8 w-8 items-center justify-center rounded text-sm', {
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/custom/date-time/MonthsView.tsx
...
const MonthsView = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    className: "grid grid-cols-4 gap-1 px-3 py-2",
    children: months.map((month, index) => /*#__PURE__*/(0,jsx_runtime.jsx)(Month, {
      date: date,
      value: value,
...
const Month = ({
  ...
  const dayDate = (0,react.useMemo)(() => new Date(year, month, date.getDate(), date.getHours(), date.getMinutes()), [date, month, year]);
  const isSelectable = (0,react.useMemo)(() => (!minDate || compareDates(dayDate, new Date(minDate), 'month') >= 0) && (!maxDate || compareDates(dayDate, new Date(maxDate), 'month') <= 0), [dayDate, minDate, maxDate]);
  const isSelected = (0,react.useMemo)(() => !!value && !compareDates(dayDate, new Date(value), 'month'), [dayDate, value]);
  const isEqualThisMonth = (0,react.useMemo)(() => !compareDates(dayDate, new Date(), 'month'), [dayDate]);
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    className: classnames_default()('mx-auto flex w-14 items-center justify-center rounded border py-3 text-sm', {
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/custom/date-time/YearsView.tsx
...
const YearsView = ({
  ...
  className: "grid grid-cols-4 gap-1 px-3 py-2",
  children: years.map((year, index) => /*#__PURE__*/(0,jsx_runtime.jsx)(Year, {
    date: date,
    value: value,
    year: year,
    minDate: minDate,
...
const Year = ({
  ...
  const dayDate = (0,react.useMemo)(() => new Date(year, date.getMonth(), date.getDate(), date.getHours(), date.getMinutes()), [date, year]);
  const isSelectable = (0,react.useMemo)(() => (!minDate || compareDates(dayDate, new Date(minDate), 'year') >= 0) && (!maxDate || compareDates(dayDate, new Date(maxDate), 'year') <= 0), [dayDate, minDate, maxDate]);
  const isSelected = (0,react.useMemo)(() => !!value && !compareDates(dayDate, new Date(value), 'year'), [dayDate, value]);
  const isEqualThisYear = (0,react.useMemo)(() => !compareDates(dayDate, new Date(), 'year'), [dayDate]);
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    className: classnames_default()('mx-auto flex w-14 items-center justify-center rounded border py-3 text-sm', {
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/custom/date-time/DateSelector.tsx
...
const DateSelector = ({
  ...
  const months = useMonths(locale);
  const [month, setMonth] = (0,react.useState)(date.getMonth());
  const [year, setYear] = (0,react.useState)(date.getFullYear());
  const [yearOffset, setYearOffset] = (0,react.useState)(0);
  (0,react.useEffect)(() => {
    setMonth(date.getMonth());
    setYear(date.getFullYear());
  }, [date]);
  const yearsRange = (0,react.useMemo)(() => {
    const yearsRangeArr = [];
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        children: [calendarView === 'days' && /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          className: "capitalize",
          children: months[month].name
        }), calendarView !== 'years' ? /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          className: "text-gray-500 dark:text-gray-300",
          children: year
        }) : /*#__PURE__*/(0,jsx_runtime.jsxs)("span", {
          className: "text-gray-500 dark:text-gray-300",
          children: [yearsRange[0], " - ", yearsRange[11]]
        })]
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "flex cursor-pointer items-center justify-center rounded px-1 transition duration-100 ease-in-out hover:bg-gray-100 disabled:cursor-not-allowed disabled:opacity-50 dark:hover:bg-gray-700",
    ...
    }), calendarView === 'days' ? /*#__PURE__*/(0,jsx_runtime.jsx)(DaysView, {
      date: date,
      value: value,
      month: month,
      year: year,
    ...
    }) : calendarView === 'months' ? /*#__PURE__*/(0,jsx_runtime.jsx)(MonthsView, {
      date: date,
      value: value,
      year: year,
      minDate: minDate,
      ...
      locale: locale,
      selectMonth: selectMonth
    }) : /*#__PURE__*/(0,jsx_runtime.jsx)(YearsView, {
      date: date,
      value: value,
      years: yearsRange,
      minDate: minDate,
...
const ChevronUpIcon_ForwardRef = react.forwardRef(ChevronUpIcon);
...
const ChevronDownIcon_ForwardRef = react.forwardRef(ChevronDownIcon);
/* harmony default export */ const esm_ChevronDownIcon = (ChevronDownIcon_ForwardRef);
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/custom/date-time/TimeSelector.tsx
...
const TimeSelector = ({
  ...
  const editDateField = (field, diff) => () => {
    const newDate = dayjs_min_default()(date).add(diff, field).toDate();
  ...
  const onWheel = field => event => editDateField(field, event.deltaY < 0 ? 1 : -1)();
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("label", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(esm_ChevronUpIcon, Object.assign({
          className: "h-4 w-4 rounded hover:bg-gray-100 dark:hover:bg-gray-700",
          onClick: editDateField('hours', 1)
        }, increaseHours)), /*#__PURE__*/(0,jsx_runtime.jsx)(esm_ChevronDownIcon, Object.assign({
          className: "h-4 w-4 rounded hover:bg-gray-100 dark:hover:bg-gray-700",
          onClick: editDateField('hours', -1)
        }, decreaseHours))]
      }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: "flex items-center rounded border border-gray-100 bg-gray-100 text-right dark:border-gray-700 dark:bg-gray-700",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          className: "flex px-2",
          onWheel: onWheel('hours'),
          children: date.getHours().toString().padStart(2, '0')
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          children: ":"
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          className: "flex px-2",
          onWheel: onWheel('minutes'),
          children: date.getMinutes().toString().padStart(2, '0')
        })]
      }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: "flex flex-col items-center justify-center",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(esm_ChevronUpIcon, Object.assign({
        ...
        }, increaseMinutes)), /*#__PURE__*/(0,jsx_runtime.jsx)(esm_ChevronDownIcon, Object.assign({
          className: "h-4 w-4 rounded hover:bg-gray-100 dark:hover:bg-gray-700",
          onClick: editDateField('minutes', -1)
        }, decreaseMinutes))]
      })]
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/custom/date-time/index.tsx
...
const DateTimeInput = /*#__PURE__*/(0,react.forwardRef)(({
  className,
  name,
  label,
  description,
  ...
  onChange,
  onBlur,
  displayFormat: _displayFormat = 'dddd, MMMM Do YYYY, HH:mm:ss',
  displayLocale: _displayLocale = 'en'
}, ref) => {
  var _ref;
  const [isOpen, setIsOpen] = (0,react.useState)();
  const [calendarView, setCalendarView] = (0,react.useState)('days');
  const date = (0,react.useMemo)(() => value ? new Date(value) : new Date(), [value]);
  const displayDate = (0,react.useMemo)(() => value && getDisplayDate(date, _displayFormat, _displayLocale), [date, value, _displayFormat, _displayLocale]);
  ...
  const setNewDate = newDate => {
    if (_type === 'date') {
      newDate = dayjs_min_default()(newDate).startOf('day').toDate();
    }
  ...
  const handleOnClick = () => {
    ...
    setIsOpen(open => !open);
    (_calendarRef$current = calendarRef.current) == null ? void 0 : _calendarRef$current.focus();
  };
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    ref: ref,
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(BasicInput, {
      type: "text",
      label: label,
      description: description,
      placeholder: (_ref = placeholder != null ? placeholder : label) != null ? _ref : 'Select date',
      readOnly: true,
      required: required,
      disabled: disabled,
      value: displayDate != null ? displayDate : '',
      hasErrors: hasErrors,
      onClick: handleOnClick,
      onKeyUp: handleOnKeyUp,
      ExtraIcon: clearable && displayDate ? esm_XMarkIcon : undefined,
      ...
      onBlur: handleOnBlur,
      ref: calendarRef,
      children: [(_type == null ? void 0 : _type.includes('date')) && /*#__PURE__*/(0,jsx_runtime.jsx)(DateSelector, {
        date: date,
        value: value,
        minDate: minDate,
        maxDate: maxDate,
        ...
        setNewDate: setNewDate
      }), calendarView === 'days' && /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: "flex select-none items-center justify-end gap-2 px-3 py-2",
        children: [(_type == null ? void 0 : _type.includes('time')) && /*#__PURE__*/(0,jsx_runtime.jsx)(TimeSelector, {
          date: date,
          minDate: minDate,
          maxDate: maxDate,
          setNewDate: setNewDate
...
const SelectInput = /*#__PURE__*/(0,react.forwardRef)((_ref, ref) => {
  let {
      className,
      items,
  ...
  const selectItem = (0,react.useCallback)(item => () => {
    setSelectedItems(selected => {
      ...
      if (selected.some(i => i.id === item.id)) {
        onChange == null ? void 0 : onChange(selected.filter(i => i.id !== item.id).map(i => i.value));
        return selected.filter(i => i.id !== item.id);
      }
      onChange == null ? void 0 : onChange([...selected, item].map(i => i.value));
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(TextInput, Object.assign({
      ...
      }), filteredItems.length === 0 && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/DropdownInput.tsx
...
function DropdownInput({
  ...
  var _ref, _findInGroupedOptions5, _findInGroupedOptions6, _findInGroupedOptions7, _findInGroupedOptions8;
  const {
    register,
    setValue,
    watch,
  ...
  const makeInternalGroupedOptions =
  // eslint-disable-next-line react-hooks/exhaustive-deps
  useCallback(makeGroupedOptions(item => item.__group, item => item.__group ? item.label : '', item => item.__group ? item.items.map(makeInternalGroupedOptions) : [], item => {
    const {
      item: value
    } = item;
    return {
      ...
      item: typeof value === 'object' ? {
        key: resolveTargetObject(value, optionsIdFieldChain != null ? optionsIdFieldChain : ['id']),
        text: resolveTargetObject(value, optionsTextFieldChain != null ? optionsTextFieldChain : ['id']),
        value: optionsValueFieldChain ? resolveTargetObject(value, optionsValueFieldChain) : value
      } : {
        key: value,
        text: value,
        value: value
  ...
  useEffect(() => {
    setOptions((options != null ? options : []).map(makeInternalGroupedOptions));
  }, [options, makeInternalGroupedOptions, optionsIdFieldChain, optionsTextFieldChain, optionsValueFieldChain]);
  const selectedValues = multiple ? ((_ref = currentValue) != null ? _ref : []).map(value => {
    var _findInGroupedOptions, _findInGroupedOptions2, _findInGroupedOptions3, _findInGroupedOptions4;
    return typeof value === 'object' ? {
      key: resolveTargetObject(value, optionsIdFieldChain != null ? optionsIdFieldChain : ['id']),
      text: (_findInGroupedOptions = (_findInGroupedOptions2 = findInGroupedOptions(optionsState, option => option.key === resolveTargetObject(value, optionsIdFieldChain != null ? optionsIdFieldChain : ['id']))) == null ? void 0 : _findInGroupedOptions2.item.text) != null ? _findInGroupedOptions : resolveTargetObject(value, optionsTextFieldChain != null ? optionsTextFieldChain : ['id'])
    } : {
      key: value,
      text: (_findInGroupedOptions3 = (_findInGroupedOptions4 = findInGroupedOptions(optionsState, option => option.key === value)) == null ? void 0 : _findInGroupedOptions4.item.text) != null ? _findInGroupedOptions3 : value
    };
  }) : typeof currentValue === 'object' && currentValue !== null ? [{
    key: resolveTargetObject(currentValue, optionsIdFieldChain != null ? optionsIdFieldChain : ['id']),
    text: (_findInGroupedOptions5 = (_findInGroupedOptions6 = findInGroupedOptions(optionsState, option => option.key === resolveTargetObject(currentValue, optionsIdFieldChain != null ? optionsIdFieldChain : ['id']))) == null ? void 0 : _findInGroupedOptions6.item.text) != null ? _findInGroupedOptions5 : resolveTargetObject(currentValue, optionsTextFieldChain != null ? optionsTextFieldChain : ['id'])
  }] : currentValue ? [{
    key: currentValue,
    text: (_findInGroupedOptions7 = (_findInGroupedOptions8 = findInGroupedOptions(optionsState, option => option.key === currentValue)) == null ? void 0 : _findInGroupedOptions8.item.text) != null ? _findInGroupedOptions7 : currentValue
  }] : [];
  const isOptionSelected = key => {
    var _ref2;
    return multiple ? !!((_ref2 = currentValue) != null ? _ref2 : []).find(value => (typeof value === 'object' ? resolveTargetObject(value, optionsIdFieldChain != null ? optionsIdFieldChain : ['id']) : value) === key) : typeof currentValue === 'object' && currentValue !== null ? resolveTargetObject(currentValue, optionsIdFieldChain != null ? optionsIdFieldChain : ['id']) === key : currentValue === key;
  };
  const filteredOptions = filterGroupedOptions(optionsState, ({
    key,
    text
  }) => !(allowAdditions || search) || !isOptionSelected(key) && (text == null ? void 0 : text.toLowerCase().includes(searchValue.toLowerCase().trim())));
  const selectOption = (key, value) => {
    ...
    if (!value) {
      var _findInGroupedOptions9, _findInGroupedOptions10;
      value = (_findInGroupedOptions9 = findInGroupedOptions(optionsState, option => option.key === key)) == null ? void 0 : (_findInGroupedOptions10 = _findInGroupedOptions9.item) == null ? void 0 : _findInGroupedOptions10.value;
    }
    inputRef.current && (inputRef.current.value = '');
    setSearchValue('');
    setValue(field, multiple ? [...(currentValue != null ? currentValue : []), value] : value);
    clearErrors(field);
  };
  const unselectValue = key => event => {
    var _ref3;
    event == null ? void 0 : event.stopPropagation();
    setValue(field, ((_ref3 = currentValue) != null ? _ref3 : []).filter(value => (typeof value === 'object' ? resolveTargetObject(value, optionsIdFieldChain != null ? optionsIdFieldChain : ['id']) : value) !== key));
    inputRef.current && (inputRef.current.value = '');
    setSearchValue('');
  };
  const addOptionAndSelect = event => {
    ...
    if (event.key === 'Enter' && value) {
      if (!filteredOptions.length && allowAdditions) {
        ...
        const firstNonGroupOption = filteredOptions.filter(item => !item.__group).map(item => !item.__group && item.item.key)[0];
    ...
    } else if (((_triggerRef$current = triggerRef.current) == null ? void 0 : _triggerRef$current.getAttribute('aria-expanded')) === 'false') {
      var _triggerRef$current2;
      (_triggerRef$current2 = triggerRef.current) == null ? void 0 : _triggerRef$current2.click();
    }
  };
    ...
    children: /*#__PURE__*/_jsx(Listbox, {
      ...
      children: /*#__PURE__*/_jsxs("div", {
        ...
        children: [/*#__PURE__*/_jsx(Label, {
          ...
          className: classNames('relative w-full cursor-default rounded-md border border-gray-300 bg-white text-left shadow-sm focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-white', {
            'border-red-600 placeholder-red-900 opacity-70 dark:border-red-500 dark:placeholder-red-500': get(errors, field),
            'mt-1': !!label
          }),
          ref: triggerRef,
          children: [/*#__PURE__*/_jsxs("div", {
            className: "flex flex-wrap items-center gap-2 py-2 pl-3 pr-8",
            children: [!selectedValues.length && !allowAdditions && !search && /*#__PURE__*/_jsx("div", {
              className: "block gap-x-1 truncate text-gray-500 dark:text-gray-400",
              children: placeholder != null ? placeholder : label
            }), selectedValues.map(({
              key,
              text
            }) => /*#__PURE__*/_jsxs("div", {
          ...
          }), get(errors, field) && /*#__PURE__*/_jsx("div", {
            className: "absolute inset-y-0 right-5 flex items-center px-3",
            children: /*#__PURE__*/_jsx(ExclamationCircleIcon, {
              className: "h-6 w-6 text-red-600"
            })
          }), /*#__PURE__*/_jsx("div", {
            className: "pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2",
            children: /*#__PURE__*/_jsx(ChevronUpDownIcon, {
              className: "h-5 w-5 text-gray-400"
            })
          })]
        }), (!search && !allowAdditions || search || filteredOptions.length > 0) && /*#__PURE__*/_jsxs(Listbox.Options, {
          ...
          ref: optionsRef,
          children: [!filteredOptions.length && /*#__PURE__*/_jsx(Listbox.Option, {
...
function GroupedOptions({
  ...
  return /*#__PURE__*/_jsx(_Fragment, {
    children: options.map(option => {
      if (option.__group) return !option.__hide && /*#__PURE__*/_jsxs(Fragment, {
        children: [/*#__PURE__*/_jsx("li", {
          className: "select-none bg-gray-300 p-2 pl-3 text-gray-900 dark:bg-gray-900/80 dark:text-gray-200",
          children: /*#__PURE__*/_jsxs("div", {
            className: "flex items-center gap-1",
            style: {
              paddingLeft: depth * 10
            },
            children: [depth > 0 && /*#__PURE__*/_jsx("i", {
              className: "uil uil-corner-down-right-alt text-lg"
            }), option.label]
          })
        }), /*#__PURE__*/_jsx(GroupedOptions, {
          depth: depth + 1,
      ...
      return (!multiple || !optionSelected) && !option.__hide && /*#__PURE__*/_jsx(Listbox.Option, {
        className: classNames('cursor-pointer select-none p-2 pl-3 text-gray-900 dark:text-gray-200', {
        ...
        children: /*#__PURE__*/_jsxs("div", {
          ...
          children: [depth > 0 && /*#__PURE__*/_jsx("i", {
            className: "uil uil-corner-down-right-alt"
          }), getOptionText(option.item)]
        })
      }, getOptionKey(option.item));
    })
  });
}
function makeGroupedOptions(isGroup, resolveLabel, resolveItems, resolveSingle) {
  return item => isGroup(item) ? {
    __group: true,
    label: resolveLabel(item),
    items: resolveItems(item)
  } : resolveSingle(item);
}
function findInGroupedOptions(options, predict) {
...
function filterGroupedOptions(options, predict) {
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/FormGroup.tsx
...
const FormGroup = ({
  ...
  className: "relative flex flex-col gap-4 rounded-lg border p-4 dark:border-gray-300",
  children: [/*#__PURE__*/_jsx("div", {
    className: "absolute top-0 right-0 rounded-bl-lg rounded-tr-lg bg-gray-500 px-2 py-1 font-medium text-white dark:bg-gray-300 dark:bg-gray-900 dark:text-gray-700",
    children: label
  }), children]
});
 ...
 * ```
 */
const index_esm_useFormContext = () => react.useContext(HookFormContext);
/**
...
function useFormState(props) {
    const methods = index_esm_useFormContext();
...
var generateWatchOutput = (names, _names, formValues, isGlobal) => {
    ...
    if (isString(names)) {
        ...
        return index_esm_get(formValues, names);
    }
    if (isArray) {
    ...
    React.useEffect(() => {
        ...
        if (_actioned.current &&
            ...
            if (control._options.resolver) {
                ...
                const field = index_esm_get(control._fields, name);
                if (field && field._f) {
                    validateField(field, index_esm_get(control._formValues, name), control._options.criteriaMode === VALIDATION_MODE.all, control._options.shouldUseNativeValidation, true).then((error) => !isEmptyObject(error) &&
                        control._subjects.state.next({
...
function createFormControl(props = {}) {
    ...
    const updateTouchAndDirty = (name, fieldValue, isBlurEvent, shouldDirty, shouldRender) => {
        ...
        if (_proxyFormState.dirtyFields && (!isBlurEvent || shouldDirty)) {
            const isPreviousFieldDirty = index_esm_get(_formState.dirtyFields, name);
            ...
            isFieldDirty =
                isFieldDirty ||
                    isPreviousFieldDirty !== index_esm_get(_formState.dirtyFields, name);
        }
        ...
        for (const name in fields) {
            ...
            if (field) {
                ...
                if (_f) {
                    ...
                    const fieldError = await validateField(field, index_esm_get(_formValues, _f.name), shouldDisplayAllAssociatedErrors, _options.shouldUseNativeValidation, isFieldArrayRoot);
    ...
    const onChange = async (event) => {
        ...
        if (field) {
            ...
            if (_options.resolver) {
                ...
                error = (await validateField(field, index_esm_get(_formValues, name), shouldDisplayAllAssociatedErrors, _options.shouldUseNativeValidation))[name];
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/with-form.tsx

const with_form_excluded = ["name", "pattern", "validate"];





function withForm(type, Component) {
  return _ref => {
    let {
        name,
        pattern,
      ...
      props = _objectWithoutPropertiesLoose(_ref, with_form_excluded);
    const {
      control
    } = index_esm_useFormContext();
    return /*#__PURE__*/(0,jsx_runtime.jsx)(Controller, {
      name: name,
      control: control,
      rules: {
        required: props.required,
      ...
      render: ({
        ...
        var _field$value;
        return /*#__PURE__*/(0,jsx_runtime.jsx)(Component, Object.assign({}, props, field, {
          value: (_field$value = field.value) != null ? _field$value : '',
...
const FormInputs = {
  Text: withForm('text', TextInput),
  Textarea: withForm('textarea', TextareaInput),
  Number: withForm('number', NumberInput),
  Checkbox: withForm('checkbox', CheckboxInput),
  DateTime: withForm('datetime-local', DateTimeInput),
  Select: withForm('select', SelectInput)
};
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/controls/index.ts
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/form/index.ts

;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/Block/index.tsx
...
const Block = ({
  ...
  className: classnames_default()(className, centered && 'mx-auto', container && 'container', fullWidth && 'w-full', fullHeight && 'h-full'),
  children: children
});
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/Card/index.tsx

const Card_excluded = ["children", "className"];
...
const Card = _ref => {
  let {
    ...
    blockProps = _objectWithoutPropertiesLoose(_ref, Card_excluded);
  return /*#__PURE__*/(0,jsx_runtime.jsx)(Block, Object.assign({
    className: classnames_default()(className, 'rounded-lg bg-white p-4 shadow dark:bg-gray-800 dark:text-white')
  }, blockProps, {
    children: children
  }));
};
...
const Flex = _ref => {
  let {
    ...
    blockProps = _objectWithoutPropertiesLoose(_ref, Flex_excluded);
  return /*#__PURE__*/(0,jsx_runtime.jsx)(Block, Object.assign({
    className: classnames_default()(className, 'flex gap-3', wrap && 'flex-wrap', directionClasses[direction][reverse ? 'reverse' : 'normal'], alignClasses[align], justifyClasses[justify])
  }, blockProps, {
    children: children
  }));
};
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/24/outline/esm/Bars3Icon.js
...
const Bars3Icon_ForwardRef = react.forwardRef(Bars3Icon);
/* harmony default export */ const esm_Bars3Icon = (Bars3Icon_ForwardRef);
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/Navbar/index.tsx
...
const Navbar = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    className: "p-3 pb-0",
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "flex w-full select-none items-center justify-between rounded-lg bg-white p-1 px-3 text-black shadow dark:bg-gray-800 dark:text-white",
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/Sidebar/index.tsx
...
const Sidebar = ({
  ...
  const [currentTab, setCurrentTab] = (0,react.useState)(window.location.pathname.replace(/^\//, '').replace(/\/$/, ''));
  const [completelyVisible, setCompletelyVisible] = (0,react.useState)(visible);
  (0,react.useEffect)(() => {
    let timeout;
    if (visible) timeout = setTimeout(() => setCompletelyVisible(true), 200);else timeout = setTimeout(() => setCompletelyVisible(false), 50);
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("nav", {
    className: "p-3 pr-0 text-black dark:text-white",
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: classnames_default()('h-full flex-col transition-all duration-200 ease-in-out', {
        'w-72': visible,
        'w-16': !visible
      }),
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: "h-full rounded-lg bg-white p-2 shadow dark:bg-gray-800",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "mb-2 cursor-pointer p-2 py-3 text-center text-2xl",
          children: /*#__PURE__*/(0,jsx_runtime.jsx)(react_router_dom_production_min.Link, {
            to: "/",
            target: "_blank",
            children: completelyVisible ? fullLogo : smallLogo
          })
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "space-y-1",
          children: items.map(({
            ...
            label,
            title
          }) => /*#__PURE__*/(0,jsx_runtime.jsx)(ItemWrapper, {
            title: title,
            children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
              className: classnames_default()('flex w-full cursor-pointer items-center rounded-md p-2 font-medium', {
                'bg-gray-100 dark:bg-gray-900 dark:text-white': currentTab === key,
                'text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700': currentTab !== key,
                'justify-center': !visible
              }),
              onClick: onLinkClick(key),
              children: [currentTab === key ? /*#__PURE__*/(0,jsx_runtime.jsx)(IconSelected, {
                className: "h-6 w-6"
...
;// CONCATENATED MODULE: ./node_modules/@headlessui/react/dist/utils/ssr.js
...
var u;let l=0;function use_id_r(){return++l}let I=(u=react.useId)!=null?u:function(){let n=a(),[e,o]=react.useState(n?use_id_r:null);return use_iso_morphic_effect_s(()=>{e===null&&o(use_id_r())},[e]),e!=null?""+e:void 0};
...
function s(e){let r=(0,react.useRef)(e);return use_iso_morphic_effect_s(()=>{r.current=e},[e]),r}

;// CONCATENATED MODULE: ./node_modules/@headlessui/react/dist/hooks/use-event.js
let use_event_o=function(t){let e=s(t);return react.useCallback((...r)=>e.current(...r),[e])};
...
let label_u=(0,react.createContext)(null);function c(){let o=(0,react.useContext)(label_u);if(o===null){let t=new Error("You used a <Label /> component, but it is not inside a relevant parent.");throw Error.captureStackTrace&&Error.captureStackTrace(t,c),t}return o}function M(){let[o,t]=(0,react.useState)([]);return[o.length>0?o.join(" "):void 0,(0,react.useMemo)(()=>function(e){let l=use_event_o(a=>(t(i=>[...i,a]),()=>t(i=>{let n=i.slice(),d=n.indexOf(a);return d!==-1&&n.splice(d,1),n}))),r=(0,react.useMemo)(()=>({register:l,slot:e.slot,name:e.name,props:e.props}),[l,e.slot,e.name,e.props]);return react.createElement(label_u.Provider,{value:r},e.children)},[t])]}let h="label",label_F=C(function(t,s){let{passive:e=!1,...l}=t,r=c(),a=`headlessui-label-${I()}`,i=use_sync_refs_y(s);use_iso_morphic_effect_s(()=>r.register(a),[a,r.register]);let n={ref:i,...r.props,id:a};return e&&("onClick"in n&&delete n.onClick,"onClick"in l&&delete l.onClick),$({ourProps:n,theirProps:l,slot:r.slot||{},defaultTag:h,name:r.name||"Label"})});

;// CONCATENATED MODULE: ./node_modules/@headlessui/react/dist/components/description/description.js
let d=(0,react.createContext)(null);function description_u(){let r=(0,react.useContext)(d);if(r===null){let t=new Error("You used a <Description /> component, but it is not inside a relevant parent.");throw Error.captureStackTrace&&Error.captureStackTrace(t,description_u),t}return r}function k(){let[r,t]=(0,react.useState)([]);return[r.length>0?r.join(" "):void 0,(0,react.useMemo)(()=>function(e){let i=use_event_o(n=>(t(o=>[...o,n]),()=>t(o=>{let c=o.slice(),p=c.indexOf(n);return p!==-1&&c.splice(p,1),c}))),s=(0,react.useMemo)(()=>({register:i,slot:e.slot,name:e.name,props:e.props}),[i,e.slot,e.name,e.props]);return react.createElement(d.Provider,{value:s},e.children)},[t])]}let description_S="p",description_F=C(function(t,a){let e=description_u(),i=`headlessui-description-${I()}`,s=use_sync_refs_y(a);use_iso_morphic_effect_s(()=>e.register(i),[i,e.register]);let n=t,o={ref:s,...e.props,id:i};return $({ourProps:o,theirProps:n,slot:e.slot||{},defaultTag:description_S,name:e.name||"Description"})});

;// CONCATENATED MODULE: ./node_modules/@headlessui/react/dist/hooks/use-resolve-button-type.js
function use_resolve_button_type_i(t){var n;if(t.type)return t.type;let e=(n=t.as)!=null?n:"button";if(typeof e=="string"&&e.toLowerCase()==="button")return"button"}function use_resolve_button_type_s(t,e){let[n,u]=(0,react.useState)(()=>use_resolve_button_type_i(t));return use_iso_morphic_effect_s(()=>{u(use_resolve_button_type_i(t))},[t.type,t.as]),use_iso_morphic_effect_s(()=>{n||!e.current||e.current instanceof HTMLButtonElement&&!e.current.hasAttribute("type")&&u("button")},[n,e]),n}

;// CONCATENATED MODULE: ./node_modules/@headlessui/react/dist/internal/hidden.js
let hidden_a="div";var hidden_s=(e=>(e[e.None=1]="None",e[e.Focusable=2]="Focusable",e[e.Hidden=4]="Hidden",e))(hidden_s||{});let hidden_h=C(function(t,o){let{features:e=1,...r}=t,d={ref:o,"aria-hidden":(e&2)===2?!0:void 0,style:{position:"fixed",top:1,left:1,width:1,height:0,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",borderWidth:"0",...(e&4)===4&&(e&2)!==2&&{display:"none"}}};return $({ourProps:d,theirProps:r,slot:{},defaultTag:hidden_a,name:"Hidden"})});

;// CONCATENATED MODULE: ./node_modules/@headlessui/react/dist/utils/form.js
function form_e(n={},r=null,t=[]){for(let[i,o]of Object.entries(n))f(t,form_s(r,i),o);return t}function form_s(n,r){return n?n+"["+r+"]":r}function f(n,r,t){if(Array.isArray(t))for(let[i,o]of t.entries())f(n,form_s(r,i.toString()),o);else t instanceof Date?n.push([r,t.toISOString()]):typeof t=="boolean"?n.push([r,t?"1":"0"]):typeof t=="string"?n.push([r,t]):typeof t=="number"?n.push([r,`${t}`]):t==null?n.push([r,""]):form_e(t,r,n)}function form_p(n){var t;let r=(t=n==null?void 0:n.form)!=null?t:n.closest("form");if(!!r){for(let i of r.elements)if(i.tagName==="INPUT"&&i.type==="submit"||i.tagName==="BUTTON"&&i.type==="submit"||i.nodeName==="INPUT"&&i.type==="image"){i.click();return}}}

;// CONCATENATED MODULE: ./node_modules/@headlessui/react/dist/hooks/use-controllable.js
function use_controllable_p(e,t,u){let[l,s]=(0,react.useState)(u),i=e!==void 0;return[i?e:l,use_event_o(r=>(i||s(r),t==null?void 0:t(r)))]}

;// CONCATENATED MODULE: ./node_modules/@headlessui/react/dist/components/switch/switch.js
let switch_h=(0,react.createContext)(null);switch_h.displayName="GroupContext";let z=react.Fragment;function J(b){let[t,o]=(0,react.useState)(null),[i,d]=M(),[a,s]=k(),u=(0,react.useMemo)(()=>({switch:t,setSwitch:o,labelledby:i,describedby:a}),[t,o,i,a]),p={},m=b;return react.createElement(s,{name:"Switch.Description"},react.createElement(d,{name:"Switch.Label",props:{onClick(){!t||(t.click(),t.focus({preventScroll:!0}))}}},react.createElement(switch_h.Provider,{value:u},$({ourProps:p,theirProps:m,defaultTag:z,name:"Switch.Group"}))))}let Q="button",V=C(function(t,o){let{checked:i,defaultChecked:d=!1,onChange:a,name:s,value:u,...p}=t,m=`headlessui-switch-${I()}`,r=(0,react.useContext)(switch_h),y=(0,react.useRef)(null),P=use_sync_refs_y(y,o,r===null?null:r.setSwitch),[n,f]=use_controllable_p(i,a,d),T=use_event_o(()=>f==null?void 0:f(!n)),v=use_event_o(e=>{if(bugs_r(e.currentTarget))return e.preventDefault();e.preventDefault(),T()}),k=use_event_o(e=>{e.key===keyboard_o.Space?(e.preventDefault(),T()):e.key===keyboard_o.Enter&&form_p(e.currentTarget)}),g=use_event_o(e=>e.preventDefault()),C=(0,react.useMemo)(()=>({checked:n}),[n]),D={id:m,ref:P,role:"switch",type:use_resolve_button_type_s(t,y),tabIndex:0,"aria-checked":n,"aria-labelledby":r==null?void 0:r.labelledby,"aria-describedby":r==null?void 0:r.describedby,onClick:v,onKeyUp:k,onKeyPress:g};return react.createElement(react.Fragment,null,s!=null&&n&&react.createElement(hidden_h,{features:hidden_s.Hidden,...F({as:"input",type:"checkbox",hidden:!0,readOnly:!0,checked:n,name:s,value:u})}),$({ourProps:D,theirProps:p,slot:C,defaultTag:Q,name:"Switch"}))}),be=Object.assign(V,{Group:J,Label:label_F,Description:description_F});
...
const MoonIcon_ForwardRef = react.forwardRef(MoonIcon);
/* harmony default export */ const esm_MoonIcon = (MoonIcon_ForwardRef);
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/24/outline/esm/SunIcon.js
...
const SunIcon_ForwardRef = react.forwardRef(SunIcon);
/* harmony default export */ const esm_SunIcon = (SunIcon_ForwardRef);
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/ThemeSwitcher/index.tsx
...
const ThemeSwitcher = ({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(be, {
    checked: darkMode,
    onChange: toggleTheme,
    className: classnames_default()(className, 'flex h-8 w-14 items-center rounded-full border p-1 dark:border-blue-700', {
      'bg-blue-700': darkMode,
      'bg-gray-100': !darkMode
    }),
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: classnames_default()('flex transform transition duration-200 ease-in-out', {
        'translate-x-6': darkMode,
        'translate-x-0': !darkMode
      }),
      children: darkMode ? /*#__PURE__*/(0,jsx_runtime.jsx)(esm_MoonIcon, {
        className: "h-6 w-6 rounded-full bg-gray-800 p-1 text-white"
      }) : /*#__PURE__*/(0,jsx_runtime.jsx)(esm_SunIcon, {
        className: "h-6 w-6 rounded-full bg-gray-200 p-1 text-black"
      })
    })
  });
};
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/Layout/index.tsx
...
const Layout = ({
  ...
  const [sidebarVisible, setSidebarVisible] = (0,react.useState)(false);
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "flex h-screen bg-gray-100 dark:bg-gray-900",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Sidebar, Object.assign({
      visible: sidebarVisible
    }, sidebarProps)), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "flex w-full flex-col overflow-hidden",
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Navbar, {
        toggleSidebar: () => setSidebarVisible(!sidebarVisible),
        children: [navbarChildren, /*#__PURE__*/(0,jsx_runtime.jsx)(ThemeSwitcher, {})]
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/Spinner/index.tsx
...
const Spinner = ({
  ...
  className: classnames_default()(className, 'flex w-full items-center justify-center bg-white dark:bg-gray-800', {
    'h-screen': fullScreen,
    'h-full': !fullScreen
  }),
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/components/index.ts
...
;// CONCATENATED MODULE: ./libs/tw-react-components/src/index.ts



;// CONCATENATED MODULE: ./node_modules/@heroicons/react/24/outline/esm/HomeIcon.js
...
const AdjustmentsHorizontalIcon_ForwardRef = react.forwardRef(AdjustmentsHorizontalIcon);
/* harmony default export */ const esm_AdjustmentsHorizontalIcon = (AdjustmentsHorizontalIcon_ForwardRef);
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/24/solid/esm/HomeIcon.js


function HomeIcon_HomeIcon({
  title,
  titleId,
  ...props
}, svgRef) {
...
const esm_HomeIcon_ForwardRef = react.forwardRef(HomeIcon_HomeIcon);
/* harmony default export */ const solid_esm_HomeIcon = (esm_HomeIcon_ForwardRef);
;// CONCATENATED MODULE: ./node_modules/@heroicons/react/24/solid/esm/AdjustmentsHorizontalIcon.js


function AdjustmentsHorizontalIcon_AdjustmentsHorizontalIcon({
  title,
  titleId,
  ...props
}, svgRef) {
...
const esm_AdjustmentsHorizontalIcon_ForwardRef = react.forwardRef(AdjustmentsHorizontalIcon_AdjustmentsHorizontalIcon);
/* harmony default export */ const solid_esm_AdjustmentsHorizontalIcon = (esm_AdjustmentsHorizontalIcon_ForwardRef);
...
const CurrencyDollarIcon_ForwardRef = react.forwardRef(CurrencyDollarIcon);
/* harmony default export */ const esm_CurrencyDollarIcon = (CurrencyDollarIcon_ForwardRef);
;// CONCATENATED MODULE: ./apps/demo/src/pages/FormControls.tsx
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(Flex, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Flex, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Card, {
        fullWidth: true,
        children: ["With ", /*#__PURE__*/(0,jsx_runtime.jsx)("code", {
          className: "rounded bg-gray-100 p-1 dark:bg-gray-900",
          children: "use-form-hook"
        }), ' ', "context"]
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(Card, {
        fullWidth: true,
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(FormProvider, Object.assign({}, form, {
          children: /*#__PURE__*/(0,jsx_runtime.jsx)("form", {
            onSubmit: form.handleSubmit(onSubmit, onInvalid),
            children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Flex, {
              direction: "column",
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)(FormInputs.Text, {
                className: "w-full",
                name: "text",
                label: "Text",
                placeholder: "Text",
                required: true
              }), /*#__PURE__*/(0,jsx_runtime.jsx)(FormInputs.Textarea, {
                className: "w-full",
                name: "textarea",
                label: "Full Text",
                ...
                rows: 5,
                required: true
              }), /*#__PURE__*/(0,jsx_runtime.jsx)(FormInputs.Number, {
                className: "w-full",
                name: "number",
                label: "Number",
                placeholder: "0",
                ...
                ExtraIcon: esm_CurrencyDollarIcon,
                required: true
              }), /*#__PURE__*/(0,jsx_runtime.jsx)(FormInputs.Checkbox, {
                className: "w-full",
                name: "checkbox",
                label: "Checkbox",
                required: true
              }), /*#__PURE__*/(0,jsx_runtime.jsx)(FormInputs.DateTime, {
                className: "w-full",
                name: "date",
                label: "DateTime",
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Card, {
        fullWidth: true,
        children: ["Without ", /*#__PURE__*/(0,jsx_runtime.jsx)("code", {
          className: "rounded bg-gray-100 p-1 dark:bg-gray-900 ",
          children: "use-form-hook"
        }), ' ', "context"]
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(Card, {
        ...
        children: /*#__PURE__*/(0,jsx_runtime.jsx)("form", {
          ...
          children: /*#__PURE__*/(0,jsx_runtime.jsxs)(Flex, {
            direction: "column",
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(TextInput, {
              className: "w-full",
              name: "text",
              label: "Text",
              value: (_formState$text = formState.text) != null ? _formState$text : '',
              onChange: setFormField('text', 'value'),
              placeholder: "Text",
              required: true
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(TextareaInput, {
              className: "w-full",
              name: "textarea",
              label: "Full Text",
              value: (_formState$textarea = formState.textarea) != null ? _formState$textarea : '',
              onChange: setFormField('textarea', 'value'),
              placeholder: "Full Text",
              rows: 5,
              required: true
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(NumberInput, {
              className: "w-full",
              name: "number",
              label: "Number",
              value: (_formState$number = formState.number) != null ? _formState$number : '',
              onChange: setFormField('number', 'value'),
              placeholder: "0",
              min: 0,
              hasErrors: ((_formState$number2 = formState.number) != null ? _formState$number2 : 0) > 10,
              ExtraIcon: esm_CurrencyDollarIcon,
              required: true
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(CheckboxInput, {
              className: "w-full",
              name: "checkbox",
              label: "Checkbox",
              checked: (_formState$checkbox = formState.checkbox) != null ? _formState$checkbox : false,
              onChange: setFormField('checkbox', 'checked'),
              required: true
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(DateTimeInput, {
              className: "w-full",
              name: "date",
              label: "DateTime",
              displayFormat: "DD-MM-YYYY [at] HH:mm",
...
;// CONCATENATED MODULE: ./apps/demo/src/pages/Home.tsx
...
;// CONCATENATED MODULE: ./apps/demo/src/app.tsx
...
const App = () => {
  const sidebarProps = (0,react.useMemo)(() => ({
    items: [{
      key: '',
      title: 'Home',
      Icon: esm_HomeIcon,
      IconSelected: solid_esm_HomeIcon
    }, {
      key: 'form-controls',
      title: 'Form Controls',
      Icon: esm_AdjustmentsHorizontalIcon,
      IconSelected: solid_esm_AdjustmentsHorizontalIcon
    }],
    smallLogo: 'SL',
    fullLogo: 'Full Logo'
  }), []);
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(react_router_dom_production_min.Routes, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(react_router_dom_production_min.Route, {
      path: "",
      element: /*#__PURE__*/(0,jsx_runtime.jsx)(Layout, {
        sidebarProps: sidebarProps,
        children: /*#__PURE__*/(0,jsx_runtime.jsx)(react_router_dom_production_min.Outlet, {})
      }),
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(react_router_dom_production_min.Route, {
        ...
        path: "form-controls",
        element: /*#__PURE__*/(0,jsx_runtime.jsx)(FormControls, {})
      })]
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(react_router_dom_production_min.Route, {
      path: "*",
...
;// CONCATENATED MODULE: ./apps/demo/src/main.tsx
...
root.render( /*#__PURE__*/(0,jsx_runtime.jsx)(react.StrictMode, {
  children: /*#__PURE__*/(0,jsx_runtime.jsx)(react.Suspense, {
    fallback: /*#__PURE__*/(0,jsx_runtime.jsx)(Spinner, {
      fullScreen: true
    }),
