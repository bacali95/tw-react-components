  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'fixed left-[50%] top-[50%] z-50 flex w-full max-w-lg translate-x-[-50%] translate-y-[-50%] flex-col gap-4 bg-white p-4 shadow-lg duration-200 sm:rounded-lg dark:bg-slate-800 dark:text-white',
        className
      )}
      {...props}
    >
